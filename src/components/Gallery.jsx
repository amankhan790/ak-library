...
const galleryItems = [
    { id: 4, category: 'Study Hall', title: 'Focused reading space', image: '/gallery/hall2.jpeg' },
    { id: 1, category: 'Study Hall', title: 'Quiet study hall', image: '/gallery/hall.jpeg' },
    { id: 2, category: 'Students', title: 'Students studying', image: '/facilities/hall.jpeg' },
    { id: 3, category: 'Events', title: 'Library event space', image: '/gallery/study.jpeg' },
    ...
    { id: 8, category: 'Interior', title: 'Long reading rows', image: '/gallery/reading row.jpeg' },
    ...
    return (
        <section id="gallery" className="bg-white  pt-10 sm:pt-14 lg:py-20">
            <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
                ...
                <Reveal as="div" delay={90} className="mt-8 flex flex-wrap items-center justify-center gap-3 sm:mt-10 sm:gap-4" distance={16}>
                ...
                <Reveal as="div" delay={160} className="mt-8 flex justify-center sm:mt-10" distance={16}>
                    <button
                        type="button"
